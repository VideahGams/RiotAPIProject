...
Theme.Button.draw = function(self)
    love.graphics.setColor(17, 168, 171)
    if self.hot then love.graphics.setColor(19, 193, 198) end
    if self.down then love.graphics.setColor(12, 121, 124) end
...
Theme.Textarea.draw = function(self)
    ...
    love.graphics.setColor(80, 89, 123)
    love.graphics.rectangle('fill', self.x, self.y, self.w, self.h)
    ...
    if self.selected then 
        -- Draw selection
        love.graphics.setColor(144, 153, 183, 90)
